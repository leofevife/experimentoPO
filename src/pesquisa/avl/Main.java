...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // Arquivos de dados, DEIXA NA RAIZ MSM PRA FICAR VISIVEL
        ...
        // Instancia o processador da avl!
        ProcessadorExperimentoAVL processador = new ProcessadorExperimentoAVL(arquivosDados, arquivoNomes);
